...
Additionally, implement typed properties with `@ConfigurationProperties`:
...
7. **OpenAPI Specification** Generate OpenAPI Specification documentation and put it in `src/main/resources//static/openapi.yaml`,
